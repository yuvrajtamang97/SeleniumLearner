...
import staticfields.StaticInstances;
...
//public class Saucedemostepdefination {
    ...
    public void user_should_be_able_to_see_the_homepage() {
        ...
        String homepagetext = SingletonBrowserClass.getInstanceOfSingletonBrowserClass().getDriver().findElement(By.xpath("//div[@class='header_label']")).getText();
